...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:Panel ID="RegistrationPanel" runat="server" Height="1100px" HorizontalAlign="Center">
        <br />
        ...
        <br />
        <br />
        <asp:Label ID="CorrectValidationLabel" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="Green" Text="Rejestracja użytkownika przebiegła pomyślnie" Visible="False"></asp:Label>
        <br />
        <br />
        <br />
        <br />
